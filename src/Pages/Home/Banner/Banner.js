...
const Banner = () => {
    return (
        <div className='container mx-auto flex flex-col-reverse md:flex-row justify-between items-center my-5 px-3'>
            <div className='pr-10 md:mt-0 mt-10'>
                ...
                <button className='bg-purple-600 duration-700 hover:bg-purple-800 py-3 px-7 text-white'><Link to='/inventory'>Manage Inventory</Link></button>
            </div>
            <div>
